...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_VideoPage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_VideoPage_t qt_meta_stringdata_VideoPage = {
    {
QT_MOC_LITERAL(0, 9) // "VideoPage"
...
const QMetaObject VideoPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoPage.offsetsAndSize,
    qt_meta_data_VideoPage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_VideoPage_t
, QtPrivate::TypeAndForceComplete<VideoPage, std::true_type>
